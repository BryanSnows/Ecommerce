...
function preencherListaProdutos() {
    let arrProdutos = [{
        produtoImgSrc: 'assets/img/jaqueta.svg',
    ...
    {
        produtoImgSrc: 'assets/img/gorro.svg',
    ...
    {
        produtoImgSrc: 'assets/img/mascara.svg',
        produtoTipo: 'Acessórios',
        produtoTitulo: 'Mask',
    ...
    {
        produtoImgSrc: 'assets/img/camiseta_branca.svg',
        produtoTipo: 'Camisetas',
    ...
    {
        produtoImgSrc: 'assets/img/camiseta_preta.svg',
        produtoTipo: 'Camisetas',
    ...
    {
        produtoImgSrc: 'assets/img/moletom.svg',
        produtoTipo: 'Camisetas',
